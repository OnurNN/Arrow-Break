...
- Sign In with Apple is optional. You may play without an account.
...
- Purchases are processed by Apple and are subject to Apple's Terms of Sale.
- All purchases are **final and non-refundable** unless required by applicable law.
- "Remove Ads" is a one-time purchase that removes advertisements permanently for that Apple ID.
...
- Use cheats, bots, or exploits to manipulate game progress
- Attempt to gain unauthorized access to other users' CloudKit data
...
To the fullest extent permitted by law, OnurNN shall not be liable for any indirect, incidental, or consequential damages arising from your use of the app.
